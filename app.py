...
if fetch_data:
    ...
    # ✅ NEW FUNCTION — Length-Line table
    ...
    if batting_players:
        tabs = st.tabs([
            "Foot Type", "Length", "Line", "Length-Line", "Ball Type", "Bowling End", "Bowling Type",
            "Bowler", "Shot", "Bowling Hand", "Shot Area"
        ])
        tab1, tab2, tab3, tab11, tab4, tab5, tab6, tab7, tab8, tab9, tab10 = tabs
